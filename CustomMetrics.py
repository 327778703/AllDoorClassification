# -*- coding: utf-8 -*-
# 自定义评价指标：Top2准确率和precision/recall/F1
...
class ConfusionMatrixMetric(tf.keras.metrics.Metric):
    ...
    def process_confusion_matrix(self):
        ...
        f1 = tf.reduce_mean(f1)  # 再对F1向量求平均，因此在这里，model.fit()显示时就不等于 平均后的precision和recall 的调和平均值

        return precision, recall, f1

    def fill_output(self, output):
        results = self.process_confusion_matrix()
